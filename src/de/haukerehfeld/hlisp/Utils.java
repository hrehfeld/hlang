...
public class Utils {
	 ...
	 */
	public static long writeFile(InputStream in, File file)
		throws IOException {
		return writeFile(in, file, 2048);
	}
	...
	public static long writeFile(final InputStream in,
		...
		long crc = copy(in, dest, BUFFERSIZE);
		dest.close();
	...
	public static long getCrc32(final InputStream in) throws IOException {
		return copy(in, new NoOutputStream(), BUFFERSIZE);
	}
